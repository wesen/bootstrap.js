define(function (require, exports, module) {
  ...
  jdh.objectToHtml = function (desc, o) {
    ...
    if (typeof o == 'object') {
      ...
      for (var prop in o) {
        if (o.hasOwnProperty(prop)) {
          ...
          li.appendChild(jdh.objectToHtml(prop, o[prop]));
          ul.appendChild(li);
        }
      }
  ...
  var diffNodeToHtml = function (desc, o, n, d) {
    ...
    if (d instanceof Array) {
      ...
      if (d.length === 1) {
        ...
        var div = jdh.objectToHtml(null, d[0])
        div.setAttribute('class', 'jsondiffpatch-modified-parent');
        elem.appendChild(div);
      } else if (d.length == 2) {
        // modified
        container.setAttribute('class', 'jsondiffpatch-modified');
        var parent = document.createElement('div');
        parent.setAttribute('class', 'jsondiffpatch-modified-parent');
        var d1 = document.createElement('div');
        d1.setAttribute('class', 'jsondiffpatch-modified-original');
        d1.appendChild(jdh.objectToHtml(null, d[0]));
        var d2 = document.createElement('div');
        d2.setAttribute('class', 'jsondiffpatch-modified-new');
        d2.appendChild(jdh.objectToHtml(null, d[1]));
        ...
        for (var prop in o) {
          if (o.hasOwnProperty(prop) && prop !== '_t') {
            ...
            if (!d.hasOwnProperty(k)) {
              ...
              li.appendChild(jdh.objectToHtml(k, o[prop]));
              ul.appendChild(li);
            }
          }
        }
